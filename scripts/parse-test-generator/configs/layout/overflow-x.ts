// b_path:: scripts/parse-test-generator/configs/layout/overflow-x.ts
/**
 * Test cases for overflow-x parser
 */
...
export const config: PropertyConfig = {
	...
	module: "layout",
	sourceFile: "src/parse/layout/overflow-x.ts",
	importPath: "../src/parse/layout/overflow-x.js",
	outputPath: "src/parse/layout/overflow-x.test.ts",
	cases: [
		// Valid cases
