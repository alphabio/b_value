// b_path:: scripts/parse-test-generator/configs/visual/visibility.ts
/**
...
export const config: PropertyConfig = {
	...
	module: "visual",
	sourceFile: "src/parse/visual/visibility.ts",
	importPath: "../src/parse/visual/visibility.js",
	outputPath: "src/parse/visual/visibility.test.ts",
	cases: [
