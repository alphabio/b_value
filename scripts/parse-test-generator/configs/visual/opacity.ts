// b_path:: scripts/parse-test-generator/configs/visual/opacity.ts
/**
...
export const config: PropertyConfig = {
	...
	module: "visual",
	sourceFile: "src/parse/visual/opacity.ts",
	importPath: "../src/parse/visual/opacity.js",
	outputPath: "src/parse/visual/opacity.test.ts",
	cases: [
