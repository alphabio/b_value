// b_path:: scripts/parse-test-generator/configs/visual/background-blend-mode.ts
/**
 * Test cases for background-blend-mode parser
 */
...
export const config: PropertyConfig = {
	...
	module: "visual",
	sourceFile: "src/parse/visual/background-blend-mode.ts",
	importPath: "../src/parse/visual/background-blend-mode.js",
	outputPath: "src/parse/visual/background-blend-mode.test.ts",
	cases: [
		...
		{ input: "invalid", description: "invalid keyword", category: "invalid-keyword", expectValid: false, expectedError: "Invalid background-blend-mode" },
		{ input: "blend", description: "non-standard keyword", category: "invalid-keyword", expectValid: false, expectedError: "Invalid background-blend-mode" },
