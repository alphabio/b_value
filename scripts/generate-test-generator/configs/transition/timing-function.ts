// b_path:: scripts/generate-test-generator/configs/transition/timing-function.ts
/**
 * Test cases for transition-timing-function generator
 *
 * Tests IR → CSS conversion and roundtrip validation (IR → CSS → IR)
 */

import type { TransitionTimingFunction } from "@/core/types/index.js";

export interface GenerateTestCase {
	input: TransitionTimingFunction | any;
	expected: string;
	description: string;
	category: string;
...
export const config: PropertyConfig = {
	...
	module: "transition",
	sourceFile: "src/generate/transition/timing-function.ts",
	importPath: "../src/generate/transition/timing-function.js",
	parseImportPath: "../src/parse/transition/timing-function.js",
	outputPath: "src/generate/transition/timing-function.test.ts",
	cases: [
